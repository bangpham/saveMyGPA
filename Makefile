...
SOURCES            = main.c game.c myLib.c loseScreen.c winScreen.c startScreen.c font.c instruction.c background2.c bgCloud.c spritesheetsss.c text.c GameSong.c TitleSong.c HitSound.c
DKPATH             = /Users/Bang/Desktop/2261/devkitARM/bin
CCPATH             = /usr/bin/gcc
VBASIM             = wine /Users/Bang/Desktop/2261/vba.exe
FIND               = find
COPY               = cp -r
